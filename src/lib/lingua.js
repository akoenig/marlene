...
module.exports = function(app, options) {
    ...
    var guru = {
        ...
        learn : function() {
            ...
            if (!available) {
                throw new Error('express-lingua: Please create a resource file for your default locale: '+options.defaultLocale);
            }
        },
    ...
    if (!options.defaultLocale) {
        throw new Error('express-lingua: Please define a default locale while registering the middleware.');
    } else {
